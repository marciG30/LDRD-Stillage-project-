...
BC2_new <- BC2_new %>%    mutate(Media_Type = case_when(Well2 >= 101 & Well2 <= 105 ~ "NanoWire",
                                                        Well2 >= 111 & Well2 <= 115 ~ "Water_Blank",
                                                        Well2 >= 116 & Well2 <= 120 ~ "TSB minus Dextrose",
                                                        Well2 >= 121 & Well2 <= 125 ~ "Avicel 10_01_2020",
                                                        ...
                                                        Well2 >= 151 & Well2 <= 155 ~ "Anarobic Lactobaccillius D.",
                                                        Well2 >= 156 & Well2 <= 160 ~ "Anarobic Lactobaccillius D._blank",
                                                        Well2 >= 161 & Well2 <= 165 ~ "Aerobic Lactobacillus D.",
                                                        Well2 >= 165 & Well2 <= 170 ~ "Aerobic Lactobacillus D._blank",
                                                        ...
                                                        Well2 >= 251 & Well2 <= 255 ~ "Aerobic Lactobacillus D.",
                                                        Well2 >= 256 & Well2 <= 260 ~ "Aerobic Lactobacillus D._blank",
                                                        ...
                                                        Well2 >= 291 & Well2 <= 295 ~ "A.Niger",
                                                        Well2 >= 296 & Well2 <= 300 ~ "R.pallida_blank",)) 
...
ggsave("shewanella_OD_stillages_21_05_10.tiff")
